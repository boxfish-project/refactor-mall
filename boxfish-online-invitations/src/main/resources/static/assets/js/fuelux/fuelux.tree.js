...
(function (factory) {
		...
		discloseAll: function discloseAll() {
			...
			if (!isAllDisclosed) {
				...
				*/
				...
				/*
				* If the content is very fast, calling this first will cause `disclosedVisible.fu.tree` to not
	...
	$.fn.tree.defaults = {
		...
		* falls over and dies). On the Fuel UX `index.html` content, the point at
		* which the content became super slow (enough to seem almost unresponsive)
